...
type _CoercedEnvSchema_d68f3e9f = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_d68f3e9f> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_d68f3e9f, 'VITE_PUBLIC_POSTHOG_KEY'>> {}
}
...
type _EnvSchemaAsStrings_d68f3e9f = EnvSchemaAsStrings;
declare global {

  // add types for global process.env
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_d68f3e9f {}
  }
}
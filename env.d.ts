...
type _CoercedEnvSchema_789d5db4 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_789d5db4> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_789d5db4, 'RAILWAY_ENVIRONMENT_NAME' | 'APP_ENV' | 'VITE_PUBLIC_POSTHOG_KEY'>> {}
}
...
type _EnvSchemaAsStrings_789d5db4 = EnvSchemaAsStrings;
declare global {

  // add types for global process.env
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_789d5db4 {}
  }
}
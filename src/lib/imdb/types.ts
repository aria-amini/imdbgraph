...
// Cell surfaces are theme-independent, so the ink is fixed too. White numerals
// only survive 4.5:1 on the dark red end of the scale; everything lighter
// takes dark ink, which must clear 4.5:1 even on cells just past that cutoff.
const DARK_INK = 'oklch(0.12 0 0)'
